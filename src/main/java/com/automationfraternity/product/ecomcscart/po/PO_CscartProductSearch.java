...
public class PO_CscartProductSearch 
{
	...
	UIManager PO_CscartProductSearch_UI_Manager = new UIManager();
	...
	public void SearchProductFromSearchTextBox(String computer)
	{
		PO_CscartProductSearch_UI_Manager.SetElementText( Search_Computer_Option, computer);
