...
import main.java.com.automationfraternity.core.Config;
...
public class PO_MyAccount {
	...
	public void ClickOnMyAccountTicker() {
		Reporter.log("trying to click on account ticker", true);
		...
		CmnMethods.WriteLog("pass", " My Account Pop Up is displayed. <a href='" + filepath + "'> Click Here for Screen shot</a>");
	...
	public void SignInToCSCart() {
		...
		WebDriverWait wait = new WebDriverWait(driver,Config.TIME_OUT_MAX);
